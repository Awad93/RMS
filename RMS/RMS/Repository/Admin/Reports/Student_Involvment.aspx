<%@ Page Language="C#" MasterPageFile="~/Repository/MasterPage.Master" AutoEventWireup="true" CodeBehind="Student_Involvment.aspx.cs" Inherits="RMS.Repository.Admin.Reports.Student_Involvment" %>

<asp:Content ID="head" ContentPlaceHolderID="head" runat="server">
    <title>Student Involvment</title>
        ...
        <div id="collapseMore" class="collapse in">
            ...
            <div class="criteria-item">
                <p>
                    ...
                    <asp:DropDownList ID="ddlDepartment" runat="server" CssClass="timespan-allyears" required>
                    </asp:DropDownList>
                </p>
            </div>
