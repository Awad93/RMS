...
namespace Models
{
    ...
    public partial class DepartmentController
    {
        ...
        {
            string command = "select Department_Name, Department_Code from Department where Department_Type = 'DEPT'";

            DataTable table = DbAccess.ExecuteQuery(command, CommandType.Text);
